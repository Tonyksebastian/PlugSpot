!(function (o) {
          ...
          e
            ...
            .on("click", function () {
              o(this).next(".sub-menu").slideToggle(),
                o(this).siblings("ul").addClass("open").slideToggle(),
                o(this)
            ...
            .on("click", function () {
              o(this).next(".sub-menu").slideToggle(),
                ...
                o(this).siblings("ul").hasClass("open") &&
                  o(this).parents("li").eq(1).addClass("active");
            }))
        : e.addClass("dropdown"),
    ...
    (c.Defaults = {
          ...
          run: function () {
            for (
              var t,
                ...
                n = this.coordinates(this.current()) + o,
                s = n + this.width() * i,
                r = [],
                a = 0,
              ...
              (t = this._coordinates[a - 1] || 0),
                ...
                ((this.op(t, "<=", n) && this.op(t, ">", s)) ||
                  (this.op(e, "<", n) && this.op(e, ">", s))) &&
                  r.push(a);
      ...
      (c.prototype.setup = function () {
        ...
        t
          ? (l.each(t, function (t) {
            ...
            "function" ==
              typeof (o = l.extend({}, this.options, t[i])).stagePadding &&
        ...
        this.is("dragging") &&
          ...
          this.settings.loop
            ...
            : ((i = this.settings.rtl
              ...
              (s.x = Math.max(Math.min(s.x, i + e), o + e))),
        ...
        if (n.loop) s = this._clones.length / 2 + this._items.length - 1;
          ...
          if ((e = this._items.length))
            for (
              ...
              e-- &&
              !(o < (i += this._items[e].width() + this.settings.margin));

            );
          s = e + 1;
        } else
          s = n.center ? this._items.length - 1 : this._items.length - n.items;
        ...
        return t === a
          ...
          : (this.settings.center
              ? (this.settings.rtl && ((i = -1), (o = t + 1)),
                ...
                (e +=
                  ((this.width() - e + (this._coordinates[o] || 0)) / 2) * i))
      ...
      (c.prototype.to = function (t, e) {
        var i,
          ...
          l = this.maximum();
        this.settings.loop
          ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * s * r),
            (i = (((((t = o + n) - a) % r) + r) % r) + a) !== t &&
              i - n <= l &&
              0 < i - n &&
              ((o = i - n), (t = i), this.reset(o)))
              ...
              if (
                ...
                for (
                  ...
                  this.load(s / 2 + this._core.relative(n)),
                    s && a.each(this._core.clones(this._core.relative(n)), r),
                    n++;
              }
            }, this),
        }),
  ...
  (function (d, e) {
          ...
          "prepared.owl.carousel": d.proxy(function (t) {
            ...
            !t.namespace ||
              ((e = d(t.content).find(".owl-video")).length &&
                (e.css("display", "none"), this.fetch(e, d(t.content))));
          }, this),
        }),
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.thumbnail = function (e, t) {
        function i(t) {
          (o = c.lazyLoad
            ? d("<div/>", { class: "owl-video-tn " + l, srcType: t })
            : d("<div/>", {
                class: "owl-video-tn",
        ...
        if (
          (e.wrap(d("<div/>", { class: "owl-video-wrapper", style: s })),
    ...
    (i.Defaults = {
      ...
      (i.prototype.play = function (t, e) {
        ...
        this._core.is("rotating") || this._core.enter("rotating"),
          ...
          (this._timeout = t),
          (this._call = n.setTimeout(o.proxy(this._next, this, e), t - i));
      }),
      (i.prototype.stop = function () {
        this._core.is("rotating") &&
          ((this._time = 0),
  ...
  (function (o, n) {
        ...
        (this._handlers = {
          "initialized.owl.carousel": o.proxy(function (t) {
            t.namespace &&
              ...
              o(n).trigger("hashchange.owl.navigation");
          }, this),
    ...
    (e.Defaults = { URLhashListener: !1 }),
      (e.prototype.destroy = function () {
        var t, e;
        for (t in (o(n).off("hashchange.owl.navigation"), this._handlers))
          this._core.$element.off(t, this._handlers[t]);
        for (e in Object.getOwnPropertyNames(this))
          "function" != typeof this[e] && (this[e] = null);
      }),
  ...
  (function (n, s) {
    ...
    !(function () {
      ...
      ((n.support.transition = new String(c("transition"))),
      (n.support.transition.end = t.transition.end[n.support.transition])),
      o() &&
        ((n.support.animation = new String(c("animation"))),
        (n.support.animation.end = t.animation.end[n.support.animation])),
      e() &&
        ((n.support.transform = new String(c("transform"))),
          ...
          function () {
            for (
              var t = [],
                ...
                o = /[0-9]+,[0-9]+/.test(i),
                i = i.replace(/,/g, ""),
                n = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)),
                s = n ? (i.split(".")[1] || []).length : 0,
                r = e;
              1 <= r;
              r--
            ) {
  ...
  (function (f, n, t, g) {
    var o = "stellar",
      ...
      s = (function () {
        ...
        return (
          ...
          function (t) {
            return (
              o + (0 < o.length ? t.charAt(0).toUpperCase() + t.slice(1) : t)
            );
          }
        );
      })()("transform"),
    ...
    (c.prototype = {
          ...
          (this._setPosition =
            ...
            function (t, e, i, o, n) {
              s.options.horizontalScrolling && r.setLeft(t, e, i),
                s.options.verticalScrolling && r.setTop(t, o, n);
            });
      },
      ...
      _findParticles: function () {
        ...
        if (this.particles !== g)
          for (var t = this.particles.length - 1; 0 <= t; t--)
            this.particles[t].$element.data("stellar-elementIsActive", g);
        (this.particles = []),
            ...
            this.$element.find("[data-stellar-ratio]").each(function (t) {
              ...
              p.options.showElement(l),
                l.data("stellar-startingLeft")
                  ? (l.css("left", l.data("stellar-startingLeft")),
                    l.css("top", l.data("stellar-startingTop")))
                  : (l.data("stellar-startingLeft", l.css("left")),
                    l.data("stellar-startingTop", l.css("top"))),
                (e = l.position().left),
                (i = l.position().top),
                (o =
                  "auto" === l.css("margin-left")
                    ? 0
                    : parseInt(l.css("margin-left"), 10)),
                (n =
                  "auto" === l.css("margin-top")
                    ? 0
                    : parseInt(l.css("margin-top"), 10)),
                (r = l.offset().left - o),
                (a = l.offset().top - n),
                ...
                p.particles.push({
                  ...
                  parentOffsetTop: d,
                  stellarRatio:
                    l.data("stellar-ratio") !== g ? l.data("stellar-ratio") : 1,
          ...
          this.options.parallaxBackgrounds &&
            ...
            t.each(function () {
              ...
              s.data("stellar-backgroundStartingLeft")
                ...
                : (s.data("stellar-backgroundStartingLeft", r[0]),
                  s.data("stellar-backgroundStartingTop", r[1])),
                (t =
                  "auto" === s.css("margin-left")
                    ? 0
                    : parseInt(s.css("margin-left"), 10)),
                (e =
                  "auto" === s.css("margin-top")
                    ? 0
                ...
                s.parents().each(function () {
                  var t = f(this);
                  if (!0 === t.data("stellar-offset-parent"))
                    return (a = c), (l = d), (n = t), !1;
                  (c += t.position().left), (d += t.position().top);
                }),
                (t =
                  s.data("stellar-horizontal-offset") !== g
                    ? s.data("stellar-horizontal-offset")
                    : n !== g && n.data("stellar-horizontal-offset") !== g
                    ? n.data("stellar-horizontal-offset")
                    : u.horizontalOffset),
                (e =
                  s.data("stellar-vertical-offset") !== g
                    ? s.data("stellar-vertical-offset")
                    : n !== g && n.data("stellar-vertical-offset") !== g
                ...
                u.backgrounds.push({
                  ...
                  startingBackgroundPositionLeft: isNaN(parseInt(r[0], 10))
                    ? 0
                    : parseInt(r[0], 10),
                  startingBackgroundPositionTop: isNaN(parseInt(r[1], 10))
                    ? 0
                    : parseInt(r[1], 10),
                  ...
                  parentOffsetTop: l,
                  stellarRatio:
                    s.data("stellar-background-ratio") === g
                      ? 1
      ...
      _reset: function () {
        for (var t, e, i, o, n = this.particles.length - 1; 0 <= n; n--)
        ...
        return e === g || "object" == typeof e
          ? this.each(function () {
              f.data(this, "plugin_" + o) ||
                f.data(this, "plugin_" + o, new c(this, e));
            })
          ...
          ? this.each(function () {
              ...
              t instanceof c &&
                ...
                "destroy" === e && f.data(this, "plugin_" + o, null);
            })
          : void 0;
      }),
      (f[o] = function (t) {
        ...
        f(this).on("bind", "tabactivate", function (t, e) {
          ...
          this.each(function () {
            ...
            o
              ...
              o.css({ display: "block", width: u }),
              "vertical" == l.type &&
                o
                  .find(".resp-tabs-container." + l.tabidentify)
                  .css("border-color", l.active_content_border_color),
              o
                .find(".resp-tabs-container." + l.tabidentify + " > div")
                .addClass("resp-tab-content")
                .addClass(l.tabidentify),
              "vertical" == c &&
                o.addClass("resp-vtabs").addClass(l.tabidentify),
              1 == d && o.css({ width: "100%", margin: "0px" }),
              "accordion" == c &&
                (o.addClass("resp-easy-accordion").addClass(l.tabidentify),
            ...
            o.find(".resp-accordion").each(function () {
              ...
              e.append(t.html()),
                e.data(t.data()),
                i.attr("aria-controls", l.tabidentify + "_tab_item-" + s),
                s++;
            });
            var e = 0;
            ...
            var r,
              a = 0;
            "" == h ||
              (null !== (r = h.match(new RegExp(n + "([0-9]+)"))) &&
                2 === r.length &&
                ((a = parseInt(r[1], 10) - 1), e < a && (a = 0))),
              ...
              !0 === l.closed ||
                ...
                (f(o.find(".resp-accordion." + l.tabidentify)[a])
                  .addClass("resp-tab-active")
                  .css({
                ...
                f(o.find(".resp-tab-content." + l.tabidentify)[a])
              ...
              o.find("[role=tab]").each(function () {
                f(this).on("click", function () {
                  ...
                  !e.hasClass("resp-tab-active") && e.hasClass("resp-accordion")
                    ? (o
                    ...
                    p &&
                      ...
                      (e =
                        (e = "") != t
                          ? ((i = new RegExp(n + "[0-9]+")),
                            null != t.match(i) ? t.replace(i, e) : t + "|" + e)
                          : "" + e),
      ...
      (i.prototype.handleScroll = function () {
        ...
        for (t in o) {
          ...
          for (n in this.waypoints[t]) {
            ...
            null !== c.triggerPoint &&
              ((a = s.oldScroll < c.triggerPoint),
              (l = s.newScroll >= c.triggerPoint),
              ((a && l) || (!a && !l)) &&
          ...
          for (s in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              !h && a && c
                ...
                : ((!h && d) || (h && r.oldScroll >= l.triggerPoint)) &&
  ...
  (function (t) {
    ...
    function u(t, e, i, o) {
      ...
      return (
        (n.className = "mfp-" + t),
        i && (n.innerHTML = i),
        o ? e && e.appendChild(n) : ((n = c(n)), e && n.appendTo(e)),
        n
      );
    }
    function h(t, e) {
    ...
    (t.prototype = {
      ...
      updateItemHTML: function () {
        ...
        h("BeforeChange", [f.currItem ? f.currItem.type : "", e]),
          ...
          f.currTemplate[e] ||
            ...
            h("FirstMarkupParse", i),
            (f.currTemplate[e] = !i || c(i))),
          n && n !== t.type && f.container.removeClass("mfp-" + n + "-holder");
      ...
      _openClick: function (t, e, i) {
        if (
          ...
          var o = (void 0 !== i.disableOn ? i : c.magnificPopup.defaults)
            .disableOn;
          if (o)
            if (c.isFunction(o)) {
      ...
      updateStatus: function (t, e) {
        ...
        f.preloader &&
          ...
          h("UpdateStatus", (i = { status: t, text: e })),
          (t = i.status),
          (e = i.text),
          f.preloader.html(e),
      ...
      (c.fn.magnificPopup = function (t) {
        ...
        return (
          "string" == typeof t
            ? "open" === t
              ? ((e = a ? n.data("magnificPopup") : n[0].magnificPopup),
                (i = parseInt(arguments[1], 10) || 0),
                (o = e.items
                  ? e.items[i]
                  : ((o = n), e.delegate && (o = o.find(e.delegate)), o.eq(i))),
                f._openClick({ mfpEl: o }, n, e))
              : f.isOpen &&
                f[t].apply(f, Array.prototype.slice.call(arguments, 1))
            : ((t = c.extend(!0, {}, t)),
              a ? n.data("magnificPopup", t) : (n[0].magnificPopup = t),
              f.addGroup(n, t)),
          n
        );
      });
          ...
          if (($(), t.src)) {
            ...
            return (
              n.length
                ? ((i = n[0].parentNode) &&
                    i.tagName &&
                    (T || ((C = o.hiddenClass), (T = u(C)), (C = "mfp-" + C)),
                    (k = n.after(T).detach().removeClass(C))),
                  f.updateStatus("ready"))
                : (f.updateStatus("error", o.tNotFound), (n = c("<div>"))),
              (t.inlineElement = n)
            );
          }
        ...
        getImage: function (t, e) {
          ...
          return (
            a.length &&
              ...
              (t.img = c(i).on("load.mfploader", n).on("error.mfploader", s)),
              (i.src = t.src),
          ...
          r.enabled &&
            ...
            (n = function (t) {
              var e = t
                ...
                t = "transition";
              return (
                (o["-webkit-" + t] = o["-moz-" + t] = o["-o-" + t] = o[t] = i),
                e.css(o),
                e
              );
            }),
    ...
    function j(t) {
      var e;
      !f.currTemplate[L] ||
        ((e = f.currTemplate[L].find("iframe")).length &&
          ...
          return (
            ...
            !(!s || !s.enabled) &&
              ...
              d("UpdateStatus" + t, function (t, e) {
                e.text &&
                  (e.text = F(e.text, f.currItem.index, f.items.length));
              }),
              ...
              d("BuildControls" + t, function () {
                ...
                1 < f.items.length &&
                  ...
                  (t = f.arrowLeft =
                    c(
                      e.replace(/%title%/gi, s.tPrev).replace(/%dir%/gi, "left")
                    ).addClass(r)),
                  (e = f.arrowRight =
                    c(
                      e
      ...
      function e(t, e) {
        ...
        return (
          ...
          this.s.dynamic
            ...
            : "" !== this.s.selector
            ? this.s.selectWithin
              ? (this.$items = f(this.s.selectWithin).find(this.s.selector))
      ...
      (e.prototype.init = function () {
        ...
        (e.prototype.structure = function () {
          ...
          f("body").append(o),
            ...
            n.setTop(),
            f(window).on("resize.lg orientationchange.lg", function () {
              setTimeout(function () {
                n.setTop();
              }, 100);
            }),
        ...
        (e.prototype.setTop = function () {
          var t, e, i;
          "100%" !== this.s.height &&
            ((e = ((t = f(window).height()) - parseInt(this.s.height, 10)) / 2),
        ...
        (e.prototype.loadContent = function (e, t, i) {
          ...
          if (!c.$slide.eq(e).hasClass("lg-loaded")) {
            if (
              ...
              (o = c.$slide.eq(e).find(".lg-object")),
              h && o.attr("sizes", h),
              s && (o.attr("srcset", s), this.s.supportLegacyBrowser))
            )
              try {
              ...
              i && !f("body").hasClass("lg-from-hash") && (t = i),
                setTimeout(function () {
                  c.$slide.eq(e).addClass("lg-complete"),
                    c.$el.trigger("onSlideItemLoad.lg", [e, i || 0]);
                }, t);
            }),
            p && p.html5 && !d && c.$slide.eq(e).addClass("lg-complete"),
            !0 === t &&
        ...
        (e.prototype.slide = function (t, e, i, o) {
          ...
          (d.lGalleryOn && c === t) ||
            ((n = this.$slide.length),
            (s = d.lGalleryOn ? this.s.speed : 0),
            d.lgBusy ||
              (this.s.download &&
                ((r = d.s.dynamic
                  ? !1 !== d.s.dynamicEl[t].downloadUrl &&
                    (d.s.dynamicEl[t].downloadUrl || d.s.dynamicEl[t].src)
                  : "false" !== d.$items.eq(t).attr("data-download-url") &&
                    (d.$items.eq(t).attr("data-download-url") ||
              ...
              e
                ? (this.$slide.removeClass(
                  ...
                  "prev" === o
                    ...
                    : d.$slide.eq(a).addClass("lg-prev-slide"),
              ...
              d.lGalleryOn
                ? (setTimeout(function () {
                  ...
                  setTimeout(function () {
                    (d.lgBusy = !1),
                      d.$el.trigger("onAfterSlide.lg", [c, t, e, i]);
                  }, this.s.speed))
                : (d.loadContent(t, !0, d.s.backdropDuration),
                  (d.lgBusy = !1),
                  d.$el.trigger("onAfterSlide.lg", [c, t, e, i])),
              (d.lGalleryOn = !0),
              this.s.counter && f("#lg-counter-current").text(t + 1)),
            (d.index = t));
        }),
        ...
        (e.prototype.enableDrag = function () {
          ...
          e.s.enableDrag &&
            ...
            f(window).on("mouseup.lg", function (t) {
              s
                ? ((s = !1), e.touchEnd(o - i), e.$el.trigger("onDragend.lg"))
        ...
        (t.prototype.build = function () {
          ...
          function e(t, e, i) {
            ...
            t.youtube || t.vimeo || t.dailymotion
              ? t.youtube
                ? (o = n.core.s.loadYoutubeThumbnail
                    ? "//img.youtube.com/vi/" +
                      t.youtube[1] +
                      "/" +
                ...
                ? n.core.s.loadVimeoThumbnail
                  ? ((o = "//i.vimeocdn.com/video/error_" + r + ".jpg"),
                    (i = t.vimeo[1]))
                  : (o = e)
                : t.dailymotion &&
                  (o = n.core.s.loadDailymotionThumbnail
          ...
          n.core.$outer.find(".lg-thumb").html(s),
          ...
          e.$thumbOuter.addClass("lg-grab"),
            ...
            a(window).on("mousemove.lg.thumb", function (t) {
              n &&
                ...
                (r -= o - i) > e.thumbTotalWidth - e.thumbOuterWidth &&
          ...
          e.core.$outer.find(".lg-thumb").on("touchstart.lg", function (t) {
            ...
            e.core.$outer.find(".lg-thumb").on("touchmove.lg", function (t) {
              e.thumbTotalWidth > e.thumbOuterWidth &&
                ...
                e.$thumbOuter.addClass("lg-dragging"),
                (s = e.left),
                (s -= o - i) > e.thumbTotalWidth - e.thumbOuterWidth &&
      ...
      (t.prototype.init = function () {
        ...
        o.core.$el.on(
          ...
          o.core.$el.on(
            ...
            function (t, e, i) {
              ...
              e &&
                c(e).attr(
                  "src",
                  c(e).attr("src").replace("&autoplay", "&noplay")
                );
              e = o.core.s.dynamic
          ...
          o.core.s.autoplayFirstVideo &&
            o.core.$el.on("onAferAppendSlide.lg.tm", function (t, e) {
              var i;
              o.core.lGalleryOn ||
                ((i = o.core.$slide.eq(e)),
                setTimeout(function () {
        ...
        (t.prototype.loadVideo = function (t, e, i, o, n) {
          var s = this,
            ...
            s = s.core.s.dynamic
              ? s.core.s.dynamicEl[s.core.index].title
              : s.core.$items.eq(s.core.index).attr("title") ||
                s.core.$items.eq(s.core.index).find("img").first().attr("alt");
          return (
            (s = s ? 'title="' + s + '"' : ""),
            i &&
              (a = !this.videoLoaded && this.core.s.autoplayFirstVideo ? 1 : 0),
            o.youtube
              ? ((l = "?wmode=opaque&autoplay=" + a + "&enablejsapi=1"),
                this.core.s.youtubePlayerParams &&
                  (l = l + "&" + c.param(this.core.s.youtubePlayerParams)),
                (r =
              ...
              ? ((l = "?autoplay=" + a + "&api=1"),
                this.core.s.vimeoPlayerParams &&
                  (l = l + "&" + c.param(this.core.s.vimeoPlayerParams)),
                (r =
              ...
              : o.vk &&
                ...
                this.core.s.vkPlayerParams &&
                  (l = l + "&" + c.param(this.core.s.vkPlayerParams)),
                (r =
            ...
            if (i.hasClass("lg-has-video")) {
              ...
              n = function (t, e) {
                if (
                  (i
                    .find(".lg-video")
                    .append(o.loadVideo(t, "", !1, o.core.index, e)),
                  e)
                )
                  if (o.core.s.videojs)
                    try {
              ...
              o.core.s.dynamic
                ...
                : n(
                    ...
                    o.core.$items.eq(o.core.index).attr("data-html")
                  );
              n = i.find(".lg-object");
              i.find(".lg-video").append(n),
    ...
    !(function () {
      ...
      function t(t) {
        return (
          ...
          (this.core.s = h.extend({}, o, this.core.s)),
          this.core.s.zoom &&
            this.core.doCss() &&
            (this.init(),
            (this.zoomabletimeout = !1),
            (this.pageX = h(window).width() / 2),
            (this.pageY = h(window).height() / 2 + h(window).scrollTop())),
          this
        );
      }
      var e,
      ...
      (t.prototype.init = function () {
        ...
        s.core.s.actualSize &&
          ...
          s.core.s.useLeftForZoom
            ? s.core.$outer.addClass("lg-use-left-for-zoom")
            : s.core.$outer.addClass("lg-use-transition-for-zoom"),
          this.core.$outer.find(".lg-toolbar").append(t),
          s.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (t, e, i) {
            var o = s.core.s.enableZoomAfter + i;
            h("body").hasClass("lg-from-hash") && i
              ? (o = 0)
              : h("body").removeClass("lg-from-hash"),
              (s.zoomabletimeout = setTimeout(function () {
        ...
        function e(t) {
          ...
          e
            ...
            .attr("data-scale", t),
            (s.core.s.useLeftForZoom
              ? e.parent().css({ left: -i + "px", top: -o + "px" })
              : e
                  .parent()
                  .css(
                    "transform",
        ...
        function r() {
          1 < a ? s.core.$outer.addClass("lg-zoomed") : s.resetZoom(),
            a < 1 && (a = 1),
            e(a);
        }
        function o(t, e, i, o) {
          var n = e.prop("offsetWidth"),
            e = s.core.s.dynamic
              ? s.core.s.dynamicEl[i].width || e[0].naturalWidth || n
              : s.core.$items.eq(i).attr("data-width") ||
                e[0].naturalWidth ||
                n;
          s.core.$outer.hasClass("lg-zoomed")
            ...
            : n < e && (a = e / n || 2),
            o
              ? ((s.pageX = h(window).width() / 2),
                (s.pageY = h(window).height() / 2 + h(window).scrollTop()))
              : ((s.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX),
                (s.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY)),
            r(),
            setTimeout(function () {
        ...
        s.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (t, e) {
          ...
          h("#lg-zoom-out").on("click.lg", function () {
            s.core.$outer.find(".lg-current .lg-image").length &&
              ((a -= s.core.s.scale), r());
          }),
          ...
          h("#lg-actual-size").on("click.lg", function (t) {
            o(
              t,
              s.core.$slide.eq(s.core.index).find(".lg-image"),
              s.core.index,
              !0
            );
          }),
        ...
        (t.prototype.getPossibleDragCords = function (t, e) {
          var i =
              ...
              2,
            o = Math.abs(
              this.getImageSize(t, e, "y") * Math.abs(t.attr("data-scale")) -
                this.core.$outer.find(".lg").height() +
                i
            ),
            n =
              ...
              2,
            t = Math.abs(
              this.getImageSize(t, e, "x") * Math.abs(t.attr("data-scale")) -
                this.core.$outer.find(".lg").width() +
                n
            );
          return 90 === e
            ? { minY: n, maxY: t, minX: i, maxX: o }
            : { minY: i, maxY: o, minX: n, maxX: t };
        }),
        ...
        (t.prototype.zoomSwipe = function () {
          ...
          n.core.$slide.on("touchstart.lg", function (t) {
            ...
            n.core.$outer.hasClass("lg-zoomed") &&
              ((e = n.core.$slide.eq(n.core.index).find(".lg-object")),
              (o = n.core.$slide.eq(n.core.index).find(".lg-img-rotate")[0]),
              (d = n.getCurrentRotation(o)),
              (e = n.getDragAllowedAxises(e, Math.abs(d))),
              (c = e.allowY),
              ((l = e.allowX) || c) &&
                (t.preventDefault(), (s = n.getSwipeCords(t, Math.abs(d)))));
          }),
            n.core.$slide.on("touchmove.lg", function (t) {
              var e, i;
              n.core.$outer.hasClass("lg-zoomed") &&
                ((e = n.core.$slide.eq(n.core.index).find(".lg-img-wrap")),
                t.preventDefault(),
                (a = !0),
                (r = n.getSwipeCords(t, Math.abs(d))),
                n.core.$outer.addClass("lg-zoom-dragging"),
                (i = c
                  ? -Math.abs(e.attr("data-y")) +
                    (r.y - s.y) * n.getModifier(d, "Y", o)
                  : -Math.abs(e.attr("data-y"))),
                (t = l
                  ? -Math.abs(e.attr("data-x")) +
                    (r.x - s.x) * n.getModifier(d, "X", o)
                  : -Math.abs(e.attr("data-x"))),
          ...
          n.core.$slide.on("mousedown.lg.zoom", function (t) {
            ...
            (d = e.allowY),
              ...
              n.core.$outer.hasClass("lg-zoomed") &&
                ...
                (c || d) &&
                (t.preventDefault(),
                (s = n.getDragCords(t, Math.abs(u))),
                (a = !0),
                (n.core.$outer.scrollLeft += 1),
                --n.core.$outer.scrollLeft,
            ...
            h(window).on("mousemove.lg.zoom", function (t) {
              ...
              a &&
                ((e = n.core.$slide.eq(n.core.index).find(".lg-img-wrap")),
                (l = !0),
                (r = n.getDragCords(t, Math.abs(u))),
                n.core.$outer.addClass("lg-zoom-dragging"),
                (i = d
                  ? -Math.abs(e.attr("data-y")) +
                    (r.y - s.y) * n.getModifier(u, "Y", o)
                  : -Math.abs(e.attr("data-y"))),
                (t = c
                  ? -Math.abs(e.attr("data-x")) +
                    (r.x - s.x) * n.getModifier(u, "X", o)
                  : -Math.abs(e.attr("data-x"))),
                n.core.s.useLeftForZoom
                  ? e.css({ left: t + "px", top: i + "px" })
                  : e.css(
        ...
        (t.prototype.touchendZoom = function (t, e, i, o, n) {
          var s = this,
            ...
            c =
              ...
              (e.x - t.x) * s.getModifier(n, "X", l),
            l =
              -Math.abs(r.attr("data-y")) +
              (e.y - t.y) * s.getModifier(n, "Y", l),
            n = s.getPossibleDragCords(a, Math.abs(n));
          (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
            (o &&
              (l <= -n.maxY ? (l = -n.maxY) : l >= -n.minY && (l = -n.minY)),
            i && (c <= -n.maxX ? (c = -n.maxX) : c >= -n.minX && (c = -n.minX)),
            o
        ...
        (t += o.core.s.facebook
          ...
          n("#lg-dropdown-overlay").on("click.lg", function () {
            o.core.$outer.removeClass("lg-dropdown-active"),
              n("#lg-share").attr("aria-expanded", !1);
          }),
          o.core.$el.on("onAfterSlide.lg.tm", function (t, e, i) {
            setTimeout(function () {
              n("#lg-share-facebook").attr(
                ...
                "https://www.facebook.com/sharer/sharer.php?u=" +
                  encodeURIComponent(
                    o.getSahreProps(i, "facebookShareUrl") ||
                ...
                n("#lg-share-twitter").attr(
                  ...
                  "https://twitter.com/intent/tweet?text=" +
                    ...
                    "&url=" +
                    encodeURIComponent(
                      o.getSahreProps(i, "twitterShareUrl") ||
                        window.location.href
                    )
                ),
                n("#lg-share-pinterest").attr(
                  ...
                  "http://www.pinterest.com/pin/create/button/?url=" +
                    encodeURIComponent(
                      o.getSahreProps(i, "pinterestShareUrl") ||
                        window.location.href
                    ) +
                    "&media=" +
                    encodeURIComponent(o.getSahreProps(i, "src")) +
                    "&description=" +
      ...
      (t.prototype.buildTemplates = function () {
        ...
        (t.prototype.init = function () {
          ...
          this.buildTemplates(),
            ...
            this.core.$el.on("onAferAppendSlide.lg.tm.rotate", function (t, e) {
              o.core.$slide
                .eq(e)
                .find(".lg-img-wrap")
            ...
            this.core.$el.on("onBeforeSlide.lg.tm.rotate", function (t, e, i) {
  ...
  (function (t) {
    ...
    function e(t) {
      ...
      if (
        ...
        "axis" in i && i.axis === i.HORIZONTAL_AXIS && ((s = -1 * r), (r = 0)),
        (n = 0 === r ? s : r),
        "deltaY" in i && (n = r = -1 * i.deltaY),
        "deltaX" in i && ((s = i.deltaX), 0 === r && (n = -1 * s)),
        0 !== r || 0 !== s)
      ) {
        1 === i.deltaMode
          ? ((n *= e = d.data(this, "mousewheel-line-height")),
            (r *= e),
            (s *= e))
          : 2 === i.deltaMode &&
            ((n *= e = d.data(this, "mousewheel-page-height")),
            (r *= e),
            (s *= e));
        var a = Math.max(Math.abs(r), Math.abs(s));
        return (
          (f && !(a < f)) || (h(i, (f = a)) && (f /= 40)),
          h(i, a) && ((n /= 40), (s /= 40), (r /= 40)),
  ...
  Prism = (function (l) {
      ...
      A = {
        ...
        util: {
          encode: function (t) {
            return t instanceof P
              ? new P(t.type, A.util.encode(t.content), t.alias)
              : Array.isArray(t)
              ? t.map(A.util.encode)
              : t
                  .replace(/&/g, "&amp;")
          ...
          clone: function i(t, o) {
            ...
            switch (((o = o || {}), s)) {
              case "Object":
                ...
                for (var r in ((n = {}), (o[e] = n), t))
                  t.hasOwnProperty(r) && (n[r] = i(t[r], o));
                return n;
              case "Array":
                return (
                  (e = A.util.objId(t)),
        ...
        languages: {
          ...
          insertBefore: function (i, t, e, o) {
            ...
            return (
              (o[i] = r),
              A.languages.DFS(A.languages, function (t, e) {
                e === l && t != i && (this[t] = r);
              }),
              r
            );
          ...
          DFS: function t(e, i, o, n) {
            ...
            for (s in e)
              e.hasOwnProperty(s) &&
                (i.call(e, s, e[s], o || s),
                (r = e[s]),
                "Object" !== (a = A.util.type(r)) || n[l(r)]
                  ? "Array" !== a || n[l(r)] || ((n[l(r)] = !0), t(r, i, s, n))
        ...
        highlightAllUnder: function (t, e, i) {
          ...
          for (
            var n, s = o.elements || t.querySelectorAll(o.selector), r = 0;
            (n = s[r++]);

          )
            A.highlightElement(n, !0 === e, o.callback);
        },
        highlightElement: function (t, e, i) {
          for (var o, n = "none", s = t; s && !c.test(s.className); )
            s = s.parentNode;
          s &&
            ((n = (s.className.match(c) || [, "none"])[1].toLowerCase()),
            (o = A.languages[n])),
            (t.className =
              t.className.replace(c, "").replace(/\s+/g, " ") +
              " language-" +
              n),
            t.parentNode &&
              ((s = t.parentNode),
          ...
          function r(t) {
            (a.highlightedCode = t),
              A.hooks.run("before-insert", a),
              (a.element.innerHTML = a.highlightedCode),
              A.hooks.run("after-highlight", a),
              A.hooks.run("complete", a),
              i && i.call(a.element);
          }
          var a = { element: t, language: n, grammar: o, code: t.textContent };
          A.hooks.run("before-sanity-check", a),
            a.code
              ? (A.hooks.run("before-highlight", a),
                a.grammar
                  ? e && l.Worker
                    ? (((e = new Worker(A.filename)).onmessage = function (t) {
                        r(t.data);
                      }),
                      e.postMessage(
                        JSON.stringify({
                    ...
                    : r(A.highlight(a.code, a.grammar, a.language))
                  : r(A.util.encode(a.code)))
              : A.hooks.run("complete", a);
        },
        highlight: function (t, e, i) {
          ...
          return (
            ...
            P.stringify(A.util.encode(i.tokens), i.language)
          );
        },
        matchGrammar: function (t, e, i, o, n, s, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              if (a == r) return;
              for (
                var l = i[a], l = "Array" === A.util.type(l) ? l : [l], c = 0;
                c < l.length;
                ++c
              ) {
                var d,
                ...
                f &&
                  !u.pattern.global &&
                  ((d = u.pattern.toString().match(/[imuy]*$/)[0]),
                ...
                for (var y = o, v = n; y < e.length; v += e[y].length, ++y) {
                  ...
                  if (!(b instanceof P)) {
                    if (f && y != e.length - 1) {
                      ...
                      for (
                        var w = T.index + (p ? T[1].length : 0),
                          x = T.index + T[0].length,
                          _ = y,
                          $ = v,
                          C = e.length;
                        _ < C && ($ < x || (!e[_].type && !e[_ - 1].greedy));
                        ++_
                      )
                        ($ += e[_].length) <= w && (++y, (v = $));
                      if (e[y] instanceof P) continue;
                      (k = _ - y), (b = t.slice(v, $)), (T.index -= v);
                    } else {
                      u.lastIndex = 0;
                      var T = u.exec(b),
                        k = 1;
                    ...
                    if (T) {
                      p && (g = T[1] ? T[1].length : 0),
                        (x = (w = T.index + g) + (T = T[0].slice(g)).length);
                      var S = b.slice(0, w),
                        E = b.slice(x),
                        b = [y, k];
                      S && (++y, (v += S.length), b.push(S));
                      S = new P(a, h ? A.tokenize(T, h) : T, m, T, f);
                      if (
                        (b.push(S),
                        E && b.push(E),
                        Array.prototype.splice.apply(e, b),
                        1 != k && A.matchGrammar(t, e, i, y, v, !0, a),
                        s)
                      )
                        break;
                    } else if (s) break;
        ...
        hooks: {
          ...
          run: function (t, e) {
            var i = A.hooks.all[t];
            if (i && i.length) for (var o, n = 0; (o = i[n++]); ) o(e);
          },
        },
        Token: P,
      };
    ...
    if (
      ...
      (P.stringify = function (t, e) {
        ...
        t.alias &&
          ((o = Array.isArray(t.alias) ? t.alias : [t.alias]),
            ...
            l.addEventListener(
              ...
              function (t) {
                var e = JSON.parse(t.data),
                  ...
                  t = e.code,
                  e = e.immediateClose;
                l.postMessage(A.highlight(t, A.languages[i], i)),
                  e && l.close();
              },
              !1
            )),
...
"undefined" != typeof module && module.exports && (module.exports = Prism),
    ...
    function (t, e, i) {
      ...
      (s.window.jarallax = r.default),
        ...
        void 0 !== s.jQuery &&
          ...
          (l = s.jQuery.fn.jarallax),
          (s.jQuery.fn.jarallax = i),
    ...
    function (t, A, P) {
      ...
      (function (t) {
        ...
        var c =
          ...
          m = !1;
        function y(t) {
          (f = n.window.innerWidth || document.documentElement.clientWidth),
            (g = r
              ? (!u &&
                  document.body &&
        ...
        y(),
          ...
          n.window.addEventListener("orientationchange", y),
          n.window.addEventListener("load", y),
              ...
              t &&
                ...
                (0, o.default)(function () {
                  t.forEach(function (t) {
                    t.target &&
                      t.target.jarallax &&
                      (p || t.target.jarallax.onResize(), (m = !0));
                  });
                });
            }),
          T = 0,
            ...
            (_ = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (i.options.keepImg ||
                      ((t = i.$item.getAttribute("style")) &&
                        i.$item.setAttribute(
                          "data-jarallax-original-styles",
                          t
                        ),
                      i.image.useImgTag &&
                        (e = i.image.$item.getAttribute("style")) &&
                        i.image.$item.setAttribute(
                          "data-jarallax-original-styles",
                          e
                        )),
                    "static" === i.css(i.$item, "position") &&
                      i.css(i.$item, { position: "relative" }),
                    "auto" === i.css(i.$item, "z-index") &&
                      i.css(i.$item, { zIndex: 0 }),
                    (i.image.$container = document.createElement("div")),
                    i.css(i.image.$container, o),
                    i.css(i.image.$container, { "z-index": i.options.zIndex }),
                    c && i.css(i.image.$container, { opacity: 0.9999 }),
                    i.image.$container.setAttribute(
                      "id",
                      "jarallax-container-" + i.instanceID
                    ),
                    i.$item.appendChild(i.image.$container),
                    i.image.useImgTag
                      ? (n = i.extend(
                          {
                      ...
                      : ((i.image.$item = document.createElement("div")),
                        i.image.src &&
                          (n = i.extend(
                            {
                              ...
                              "background-image":
                                i.image.bgImage || 'url("' + i.image.src + '")',
                            },
                            o,
                            n
                          ))),
                    ("opacity" !== i.options.type &&
                      "scale" !== i.options.type &&
                      "scale-opacity" !== i.options.type &&
                      1 !== i.options.speed) ||
                      (i.image.position = "absolute"),
                    "fixed" === i.image.position)
                  )
                    for (
                      var s = 0, r = i.$item;
                      null !== r && r !== document && 0 === s;

                    ) {
                      var a =
                        i.css(r, "-webkit-transform") ||
                        i.css(r, "-moz-transform") ||
                        i.css(r, "transform");
                      a &&
                        "none" !== a &&
                        ((s = 1), (i.image.position = "absolute")),
                        (r = r.parentNode);
                    }
                  (n.position = i.image.position),
                    i.css(i.image.$item, n),
                    i.image.$container.appendChild(i.image.$item),
                    i.onResize(),
                    i.onScroll(!0),
                    i.options.automaticResize && C && C.observe(i.$item),
                    i.options.onInit && i.options.onInit.call(i),
                    "none" !== i.css(i.$item, "background-image") &&
                      i.css(i.$item, { "background-image": "none" }),
                    i.addToParallaxList();
                },
              },
              {
                  ...
                  l.options.elementInViewport &&
                    ...
                    (t || l.isElementInViewport) &&
                      ...
                      ("scale" !== l.options.type &&
                        ...
                        (h.transform = "scale(" + a + ") translate3d(0,0,0)")),
                      ("scroll" !== l.options.type &&
                        "scroll-opacity" !== l.options.type) ||
                        ((a = l.parallaxScrollDistance * p),
                        "absolute" === l.image.position && (a -= d),
                        (h.transform = "translate3d(0," + a + "px,0)")),
        ...
        function S(t, e) {
          ...
          Object.keys(s).forEach(function (t) {
            ...
            (i.options = i.extend({}, i.defaults, r, e)),
        ...
        function E(t, e) {
          ...
          for (
            ...
            if (
              ("object" === (void 0 === i ? "undefined" : l(i)) || void 0 === i
                ? t[s].jarallax || (t[s].jarallax = new k(t[s], i))
                : t[s].jarallax &&
                  (r = t[s].jarallax[i].apply(t[s].jarallax, o)),
              void 0 !== r)
            )
              return r;
          return t;
        }
        (E.constructor = k), (A.default = E);
      }).call(this, P(5));
    },
    function (t, e, i) {
      "use strict";
      var o = i(15),
        ...
        i =
          ...
          clearTimeout;
      Function.prototype.bind && ((n = n.bind(o)), (i = i.bind(o))),
        ((t.exports = n).cancel = i);
    },
    function (e, t, i) {
      "use strict";
      (function (t) {
  ...
  (function (i) {
    ...
    function (t, e, i) {
      ...
      (n.default.VideoWorker = n.default.VideoWorker || o.default),
        (0, i.default)(),
    ...
    function (t, e, i) {
          ...
          (n(f, [
            ...
            },
            {
              ...
              value: function (i, o) {
                ...
                this.userEventsList &&
                  ...
                  (o
                    ? this.userEventsList[i].forEach(function (t, e) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                n.videoImage
                  ? e(n.videoImage)
                  : ("youtube" === n.type &&
                      ((t = ["maxresdefault", "sddefault", "hqdefault", "0"]),
                      (i = 0),
                    ...
                    "vimeo" === n.type &&
                      ((o = new XMLHttpRequest()).open(
                        "GET",
                        "https://vimeo.com/api/v2/video/" + n.videoID + ".json",
                        !0
                      ),
                      (o.onreadystatechange = function () {
                        ...
                        4 === this.readyState &&
                          ...
                          (n.videoImage = t[0].thumbnail_large),
                          e(n.videoImage));
                      }),
                      o.send(),
                      (o = null)));
                  ...
                  : c.onAPIready(function () {
                      ...
                      c.$video ||
                        ...
                        "youtube" === c.type &&
                          ...
                          (c.player =
                            c.player ||
                            new window.YT.Player(c.playerID, c.playerOptions)),
                          t &&
                        ...
                        "vimeo" === c.type &&
                          ...
                          c.$video ||
                            ((n = ""),
                            Object.keys(c.playerOptions).forEach(function (t) {
                              "" !== n && (n += "&"),
                                (n +=
                                  t +
                                  "=" +
                        ...
                        "local" === c.type &&
                          (c.$video ||
                            ...
                            a.appendChild(c.$video),
                            document.body.appendChild(a),
                            Object.keys(c.videoID).forEach(function (t) {
                              var e, i, o;
                              (e = c.$video),
                                (i = c.videoID[t]),
                                (o = "video/" + t),
                                ((t = document.createElement("source")).src =
                                  i),
                                (t.type = o),
                                e.appendChild(t);
                            })),
                          ...
                          (r = void 0),
                          c.player.addEventListener("playing", function (t) {
            ...
            },
            {
              ...
              value: function () {
                ...
                (l && c) ||
                  ...
                  "youtube" !== this.type ||
                    l ||
                    ((l = 1), (t = "https://www.youtube.com/iframe_api")),
                  "vimeo" !== this.type ||
                    c ||
                    ((c = 1), (t = "https://player.vimeo.com/api/player.js")),
                  t &&
            ...
            },
            {
              ...
              value: function (t) {
                var e;
                "youtube" === this.type &&
                  (("undefined" != typeof YT && 0 !== YT.loaded) || d
                    ? "object" ===
                    ...
                    ("undefined" != typeof Vimeo || u
                      ...
                      : ((u = 1),
                        (e = setInterval(function () {
                          "undefined" != typeof Vimeo &&
                            (clearInterval(e), p.resolve("done"), t());
                        }, 20)))),
                  "local" === this.type && t();
              },
            },
      ...
      function f(t, e) {
        ...
        (i.url = t),
          ...
          i.videoID && ((i.ID = a++), i.loadAPI(), i.init());
      }
      e.default = n;
    },
    function (t, e, i) {
              ...
              i.isVideoInserted ||
                ...
                i.video.getVideo(function (t) {
                  ...
                  i.css(t, {
                    ...
                    (i.$video = t),
                    i.image.$container.appendChild(t),
          ...
          t.prototype.coverImage = function () {
            ...
            return (
              s &&
                ...
                r &&
                ("IFRAME" === r || "VIDEO" === r) &&
                ((e = ((t = s.image.height) * n.image.width) / n.image.height),
                (i = (s.container.width - e) / 2),
                (o = s.image.marginTop),
                s.container.width > e &&
                  ((t =
                    ((e = s.container.width) * n.image.height) / n.image.width),
                  (i = 0),
                  (o += (s.image.height - t) / 2)),
                "IFRAME" === r && ((t += 400), (o -= 200)),
                n.css(n.$video, {
                  width: e + "px",
                  marginLeft: i + "px",
                  height: t + "px",
            ...
            if (e.isValid())
              if (t) {
                if (
                  (e.on("ready", function () {
                    var t;
                    i.options.videoPlayOnlyVisible
                      ? ((t = i.onScroll),
                        (i.onScroll = function () {
                          t.apply(i),
                            (!i.options.videoLoop &&
                              (i.options.videoLoop || i.videoEnded)) ||
                              (i.isVisible() ? e.play() : e.pause());
                        }))
                      : e.play();
                  }),
                ...
                i.defaultInitImgResult ||
                  e.getImageURL(function (t) {
                    ...
                    e &&
                      i.$item.setAttribute("data-jarallax-original-styles", e),
                      i.css(i.$item, {
